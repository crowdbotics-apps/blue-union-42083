"""
Django settings for blue_union_42083 project.
...
ROOT_URLCONF = 'blue_union_42083.urls'
...
WSGI_APPLICATION = 'blue_union_42083.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "blue_union_42083 API",
    "DESCRIPTION": "API documentation for blue_union_42083 App",
    "VERSION": "v1",
}
